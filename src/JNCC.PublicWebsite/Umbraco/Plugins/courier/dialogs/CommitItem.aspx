...
<asp:Content ID="Content1" ContentPlaceHolderID="body" runat="server">
    ...
    <umb:Pane runat="server" ID="paneSelectItems" Visible="false">
        ...
        <asp:Panel runat="server" id="phSelectDestination" visible="false">
            <p>Please choose where the selected node should be transfered to below</p>
            <asp:dropdownlist runat="server" id="stepOneDDl" cssclass="destinationDDL" AppendDataBoundItems=true>
                <asp:ListItem Text="Select a destination" Value="" />
            </asp:dropdownlist>
            <asp:RequiredFieldValidator runat="server" id="validatorForStepOneDDl" 
                ErrorMessage="*"
                ForeColor="Red"
                ControlToValidate="stepOneDDl" EnableClientScript="False"></asp:RequiredFieldValidator>
        </asp:Panel>
