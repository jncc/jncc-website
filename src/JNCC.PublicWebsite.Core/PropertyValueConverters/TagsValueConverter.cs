...
{
    /// <summary>
    /// IMPORTANT: This is a hotfix and should be removed if/when UmbracoCms is upgraded to v7.13.1+
    /// 
    /// Code source: https://github.com/umbraco/Umbraco-CMS/pull/3963
    /// </summary>
    ...
    public class TagsValueConverter : PropertyValueConverterBase
    {
        ...
        public override bool IsConverter(PublishedPropertyType propertyType)
        {
            ...
            {
                return propertyType.PropertyEditorAlias.InvariantEquals(Umbraco.Core.Constants.PropertyEditors.TagsAlias);
            }
            return false;
        }
