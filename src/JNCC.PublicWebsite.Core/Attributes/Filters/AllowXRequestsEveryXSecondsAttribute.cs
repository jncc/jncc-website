...
// Sourced from https://github.com/johnstaveley/SecurityEssentials/blob/master/SecurityEssentials/Core/Attributes/AllowXRequestsEveryXSeconds.cs
namespace JNCC.PublicWebsite.Core.Attributes.Filters
{
    /// <summary>
